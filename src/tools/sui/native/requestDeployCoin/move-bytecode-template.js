// Imported from https://github.com/interest-protocol/sui-coins/blob/main/lib/move-template/coin.ts
let wasm;
...
async function __wbg_init() {
  ...
  const wasmPath = path.join(__dirname, "move_bytecode_template_bg.wasm");
  const input = fs.readFileSync(wasmPath);
